      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white tracking-tight">RetainAI</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button onClick={() => scrollToSection('security')} className="text-sm text-gray-300 hover:text-white transition-colors">Security</button>
        ...
        {isOpen && (
          <div className="md:hidden py-4 space-y-4 bg-black/90 backdrop-blur-xl absolute top-20 left-0 w-full px-4 border-b border-white/10">
            ...
            <button onClick={() => scrollToSection('security')} className="block w-full text-left py-2 text-gray-300 hover:text-white">Security</button>
            <button onClick={() => scrollToSection('pricing')} className="block w-full text-left py-2 text-gray-300 hover:text-white">Pricing</button>
            <button
              onClick={() => scrollToSection('calculator')}
