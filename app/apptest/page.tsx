...
export default function WebAppTestPage() {
    const [initData, setInitData] = useState<string>('mock-init-data')
    ...
    useEffect(() => {
        // MOCK INITIALIZATION (No Telegram Check)
        const mockPrizes = [
        ...
        setUser({ telegram_id: 999999, first_name: 'TestUser', points: 1000 });
        setLoading(false);
